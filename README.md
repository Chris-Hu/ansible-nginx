...
This project has been cloned from [geerlingguy's great job ](https://github.com/geerlingguy/ansible-role-nginx.git)

and then customed by Me, to fit my needs
...
Installs Nginx on RedHat/CentOS.

This role installs and configures the latest version of Nginx from the Nginx yum repository (on RedHat-based systems). You will likely need to do extra setup work after this role has installed Nginx, like adding your own [virtualhost].conf file inside `/etc/nginx/conf.d/`, describing the location and options to use for your particular website.
